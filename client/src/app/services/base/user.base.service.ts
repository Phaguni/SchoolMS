...
export class UserBaseService {
    ...
    */
    ...
    /**
    * UserService.findByroles
    *   @description CRUD ACTION findByroles
    *
    */
    findByRoles(id: string): Observable<User[]> {
        return this.http
            .get<User[]>(this.contextUrl + '/findByroles/' + id)
            .pipe(
                map(response => response)
            );
    }
    ...
    *
    */
    findByUsername(id: string): Observable<User[]> {
        return this.http
            .get<User[]>(this.contextUrl + '/findByusername/' + id)
            .pipe(
                map(response => response)
            );
    }
